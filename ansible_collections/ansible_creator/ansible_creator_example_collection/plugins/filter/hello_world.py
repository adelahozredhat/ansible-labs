"""A hello-world filter plugin in ansible_creator.ansible_creator_example_collection."""
...
DOCUMENTATION = """
    name: hello_world
    author: Ansible_creator Ansible_creator_example_collection
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | ansible_creator.ansible_creator_example_collection.hello_world }}"
"""
